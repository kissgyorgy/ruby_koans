...
class AboutSymbols < Neo::Koan
  ...
  # because it is automatically true, because asking about :test_method_names_become_symbols creates it.
  # assert_equal true, Symbol.all_symbols.include?(:test_method_names_becone_symbols)
